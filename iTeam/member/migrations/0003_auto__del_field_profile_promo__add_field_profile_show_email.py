...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.promo'
        db.delete_column(u'member_profile', 'promo')

        # Adding field 'Profile.show_email'
        db.add_column(u'member_profile', 'show_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.promo'
        db.add_column(u'member_profile', 'promo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Profile.show_email'
        db.delete_column(u'member_profile', 'show_email')
